  ...
  return (
    ...
    >
      ...
      >
        ...
        <div style={{ color: '#e2e8f0', fontWeight: 500 }}>BUILD: v1.5.3 (Oceanic & Mountain Shaded Relief)</div>
        <div style={{ color: '#94a3b8', fontSize: '10px' }}>BUILD DATE/TIME: 2026-09-01 07:40:00 UTC</div>
      </div>
